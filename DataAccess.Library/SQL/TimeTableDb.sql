...
CREATE TABLE IF NOT EXISTS  "Trains" (
	...
	"TrainAbbreviation"	TEXT NOT NULL,
	"TrainDescription"	TEXT NOT NULL DEFAULT '',
	"TrainClass"	TEXT NOT NULL DEFAULT '' ,
	"RouteId" INTEGER NOT NULL,
	FOREIGN KEY("RouteId") REFERENCES "Routes" ON DELETE CASCADE
);
...
CREATE TABLE  IF NOT EXISTS "TrainServices" (
	...
	FOREIGN KEY("ServiceId") REFERENCES "Services" ON DELETE SET NULL,
	UNIQUE("ServiceId")
);
